...
export default function TalentPage() {
  return (
    <>
      <Head>
        <title>Our Talent - Oakroot</title>
        <meta name="description" content="Meet the talented team behind Oakroot Solutions - Elite talent, unmatched creativity." />
      ...
      <main className="bg-white text-black px-8 lg:px-16 py-24">
        ...
        <div className="max-w-6xl mx-auto mb-16">
          <h1 className="text-6xl md:text-8xl font-bold mb-6">Our Talent</h1>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 mb-16">
            <div>
              <h2 className="text-4xl font-bold mb-6">Elite Talent</h2>
          ...
          <div className="bg-neutral-50 rounded-lg p-12 mb-16">
            <h2 className="text-4xl font-bold mb-6">Why Choose Our Team?</h2>
