...
export default function Slide4_Team() {
  return (
    <div className="w-screen h-screen flex-shrink-0 flex items-center justify-center p-8 lg:p-16 bg-white">
      <div className="max-w-7xl mx-auto w-full flex flex-col lg:flex-row items-center gap-12">
        {/* Left Side - Text */}
        <div className="flex-1 text-black">
          <h2 className="text-5xl lg:text-7xl font-bold uppercase mb-6">
            Join Us
          </h2>
          ...
          <Link
            href="/careers"
            className="inline-block bg-black text-white font-semibold rounded-full py-4 px-8 hover:bg-neutral-800 transition-colors text-lg"
          >
            View Careers
          </Link>
        </div>
        ...
        {/* Right Side - Image */}
        <div className="flex-1 aspect-[4/5] relative overflow-hidden rounded-lg">
          <Image
